...
export default function AdminError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 text-center px-6">
      <div>
        <p className="sdm-eyebrow text-[var(--admin-accent)] mb-4">
      ...
      <div className="flex items-center gap-3 flex-wrap justify-center">
        <button
          type="button"
          onClick={reset}
          className="border border-[var(--admin-accent)] text-[var(--admin-accent)] hover:bg-[var(--admin-accent-soft)] px-5 py-2.5 sdm-eyebrow transition-colors"
        >
          Try again
        </button>
        <a
          href="/admin"
          className="border border-[var(--admin-border)] text-[var(--admin-muted)] hover:border-[var(--admin-accent)] hover:text-[var(--admin-text)] px-5 py-2.5 sdm-eyebrow transition-colors"
        >
          ← Dashboard
        </a>
      </div>
